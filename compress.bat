...
copy /b %1\markashleybell.com\Scripts\twitter.js+%1\markashleybell.com\Scripts\github.js+%1\markashleybell.com\Scripts\email.js %1\markashleybell.com\Scripts\script.js
